...
2. [Orca V4.0](https://github.com/QuakedK/Orca/releases/download/UpdateOrchestrator/Orca-V4.bat) Is used as a Oneclick continuer/reenabler, by redisabling previously disabled tasks and services.
3. [Orca Lite V3.0](https://github.com/QuakedK/Orca/releases/download/UpdateOrchestrator/Orca-Lite-V3.bat) is also a Oneclick continuer/reenabler, but only redisables task.
